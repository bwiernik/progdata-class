...
Using the `tidytext::get_sentiments()` function we can take a peek at the words within.
...
We can see that this lexicon has `r nrow(tidytext::get_sentiments("bing"))` words.
...
We can see that this lexicon has `r nrow(tidytext::get_sentiments("afinn"))` words.
