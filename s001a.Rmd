# Introduction to this class and GitHub
...
- GitHub. (~35 min)
- Getting help (~10 min)
- _Second half:_ R and RStudio (~70 min)
...
The course syllabus can be found on Canvas and the class homepage, [https://wiernik-datasci.netlify.com](https://wiernik-datasci.netlify.com). 
