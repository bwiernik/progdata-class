...
When you are finishing writing and are ready to knit, use the `bbt_bib_file()`
function to generate your CSL JSON file for the items you have cited in your
document. 

(Note, that this function is currently being written by the `rbbt` developer.
If you don't see it, come back in a few days and reinstall both `rbbt` in R
and BetterBibTeX in Zotero.)

Be sure to add `bibliography: references.json` (or whatever you named your
bibliography file) to your YAML metadata.
