# Introduction to this class GitHub, and R
...
- The [GitHub guide](https://guides.github.com/) has lots of info about GitHub. If you do go here, I recommend you start with ["Hello, World!"](https://guides.github.com/activities/hello-world/). You'll see stuff about branching there -- we'll be discussing that next week.
- Dr. Jenny Bryan's ["How to get unstuck"](https://github.com/jennybc/STAT545-UBC-original-website/blob/master/help-general.md) page is useful for getting help online (even outside of STAT 545).

## Topic 1: Syllabus (20 min)

The course syllabus can be found on Canvas and the class homepage, [https://wiernik.datascience.netlify.com](https://wiernik.datascience.netlify.com). 
...
2. Tell us what your username is by filling out [this survey](https://usf.az1.qualtrics.com/jfe/form/SV_8kAdI0XraWU6geN).
...
- Follow the [setup instructions](https://wiernik.datascience.netlify.com/evaluation/participation/#setup) on the participation page. 
...
Note: These are not the assignments you will be doing in this class.

## Topic 3: Asking effective questions online (10 min)

(5 min)

We all get stuck sometimes. If you try taking [preliminary measures](https://github.com/jennybc/STAT545-UBC-original-website/blob/master/help-general.md) such as googling, you may have to turn to writing a question on a discussion board. Making your question _effective_ is an art. 
...
Now, we'll get you up to speed with a minimum "need to know" about using R and RStudio. We're going to assume you know nothing, but aren't covering the breadth of the R/RStudio landscape.
...
- A [participation repo](https://wiernik.datascience.netlify.com/evaluation/participation/#setup) on GitHub to put in-class work.
...
Alternatives exist for data analysis, python being another excellent tool, especially these days as more and more R-like functionality is added to it. The good thing about python is that it's faster and has better support for machine learning models. 
...
Often, the suite of functions that "come with" R are not very convenient.
...
Don't forget! There's an office hour after every class, held upstairs in my office.



## To do before next class

- Please fill out [this survey](https://usf.az1.qualtrics.com/jfe/form/SV_8kAdI0XraWU6geN), so that we can match you to your GitHub account.
...
3. Install GitHuh: <https://desktop.github.com/>
